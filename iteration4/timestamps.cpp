...
void Timestamps::add_timestamp() {
    ...
    QString time_input = (new_stamp_time)->text();
   
    QString comment_input = (new_stamp_comment)->text();
...
void Timestamps::set_stamp_adder(QLineEdit* new_stamp_comment_1,QLineEdit* new_stamp_time_1) {
    new_stamp_comment = new_stamp_comment_1;
    new_stamp_time=new_stamp_time_1;
}
